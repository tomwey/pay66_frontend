<template>
  <div class="list-wrapper" v-loading="loading">
    <div class="title-bar" v-if="!fromParent">
      <h3 class="title">课程单元</h3>
      <div class="buttons">
        <!-- <el-button type="primary" plain @click="composeCourse">组课</el-button> -->
        <el-button type="primary" @click="openForm(null);" v-if="$hasPermission(106,1002)">添加课程单元</el-button>
      </div>
    </div>
    ...
    <div class="list">
      ...
      >
        ...
        <el-table-column label="单元名称" prop="name" align="center" width="150"></el-table-column>
        <el-table-column label="单元简介" prop="intro" align="center" width="120"></el-table-column>
        ...
        <el-table-column label="操作" v-if="!fromParent" fixed="right" align="center" width="220">
          <template slot-scope="scope">
            <el-button
              size="mini"
              v-if="$hasPermission(106,1004)"
            ...
            <el-button
              size="mini"
              type="warning"
              v-if="scope.row.opened && $hasPermission(106,1012)"
              @click="openItem(scope.row, false);"
            >下架</el-button>
            <el-button
              size="mini"
              type="success"
              v-if="!scope.row.opened && $hasPermission(106,1011)"
  ...
  methods: {
    loadData(conds) {
      ...
      if (this.ids && this.ids.length > 0) {
        conds.push({ k: "id", op: "not", v: this.ids });
      }
